...
class MY_Model extends CI_Model
{
    ...
    protected $after_create = array('after_create');
    protected $before_update = array();
    protected $after_update = array('after_update');
    protected $before_get = array('hide_deleted');
    protected $after_get = array();
    protected $before_delete = array();
    protected $after_delete = array('after_delete');
    ...
    protected function hide_deleted()
    {
	    $this->db->where('deleted', 0);
    }

    protected function after_create($data, $id)
	{
	...
	{
		$action = (isset($data['deleted'])) ? 'delete' : 'update';
		$row_data = ($action === 'update') ? json_encode($data) : NULL;
	...
	protected function after_delete($data, $id)
	{
		$this->db->insert('history', array(
			'table_name' => $this->_table,
			'action' => 'delete',
